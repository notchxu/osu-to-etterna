...
-- MANIA STAGE LEFT AND RIGHT AND LIFEBAR
t[#t + 1] = LoadActorWithParams("stageleftright", {width=width, padding=padding, P1X=P1X,})
-- END MANIA STAGE LEFT AND RIGHT AND LIFEBAR
